import { AmountDetails, CosmosWallet, EvmWallet, TokenItemType } from "@furyanetwork/furydex-common";
import { SwapOperation, Uint128 } from "@furyanetwork/furydex-contracts-sdk";

export type UniversalSwapType =
  | "other-networks-to-furya"
  | "furya-to-furya"
  | "furya-to-evm"
  | "furya-to-cosmos"
  | "cosmos-to-others";
 ...
 * @property simulatePrice - price of the token calculated with the quote. Eg: swapping FURY to USDT => 1 FURY = 2 USDT, then simulate price = 2. TODO: Auto simulate price if not passed
 */
...
export interface FuryBridgeRouteData {
  furyBridgeChannel: string;
  furyReceiver: string;
