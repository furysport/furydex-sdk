...
import {InstantiateMsg, ExecuteMsg, OrderDirection, QueryMsg, OrderFilter, MigrateMsg, ContractInfoResponse, LastOrderIdResponse, OrderStatus, OrderResponse, OrderBookResponse, OrderBooksResponse, OrdersResponse, SimulateMarketOrderResponse, TickResponse, TicksResponse} from "./FuryswapOrderbook.types";
export interface FuryswapOrderbookReadOnlyInterface {
...
export class FuryswapOrderbookQueryClient implements FuryswapOrderbookReadOnlyInterface {
...
export interface FuryswapOrderbookInterface extends FuryswapOrderbookReadOnlyInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class FuryswapOrderbookClient extends FuryswapOrderbookQueryClient implements FuryswapOrderbookInterface {
