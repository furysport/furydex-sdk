...
import {InstantiateMsg, ExecuteMsg, QueryMsg, OracleTreasuryQuery, OracleExchangeQuery, OracleContractQuery, MigrateMsg, ContractInfoResponse, ExchangeRateResponse, ExchangeRateItem, ExchangeRatesResponse, Coin, TaxCapResponse, TaxRateResponse} from "./FuryswapOracle.types";
export interface FuryswapOracleReadOnlyInterface {
...
export class FuryswapOracleQueryClient implements FuryswapOracleReadOnlyInterface {
...
export interface FuryswapOracleInterface extends FuryswapOracleReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateAdmin: ({
    admin
...
export class FuryswapOracleClient extends FuryswapOracleQueryClient implements FuryswapOracleInterface {
