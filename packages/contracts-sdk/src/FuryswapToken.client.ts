...
import {InstantiateMsg, MinterResponse, ExecuteMsg, Expiration, Timestamp, Uint64, QueryMsg, AllAccountsResponse, AllAllowancesResponse, AllowanceInfo, AllSpenderAllowancesResponse, SpenderAllowanceInfo, AllowanceResponse, BalanceResponse, DownloadLogoResponse, LogoInfo, MarketingInfoResponse, TokenInfoResponse} from "./FuryswapToken.types";
export interface FuryswapTokenReadOnlyInterface {
...
export class FuryswapTokenQueryClient implements FuryswapTokenReadOnlyInterface {
...
export interface FuryswapTokenInterface extends FuryswapTokenReadOnlyInterface {
  contractAddress: string;
  sender: string;
  transfer: ({
    amount,
...
export class FuryswapTokenClient extends FuryswapTokenQueryClient implements FuryswapTokenInterface {
