...
import {InstantiateMsg, ExecuteMsg, QueryMsg, MigrateMsg, ConfigResponse, SimulateSwapOperationsResponse} from "./FuryswapRouter.types";
export interface FuryswapRouterReadOnlyInterface {
...
export class FuryswapRouterQueryClient implements FuryswapRouterReadOnlyInterface {
...
export interface FuryswapRouterInterface extends FuryswapRouterReadOnlyInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class FuryswapRouterClient extends FuryswapRouterQueryClient implements FuryswapRouterInterface {
