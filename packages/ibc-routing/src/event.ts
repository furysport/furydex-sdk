...
import { Gravity__factory, Gravity, generateError } from "@furyanetwork/furydex-common";
...
import { FuryBridgeRouteData, unmarshalFuryBridgeRoute } from "@furyanetwork/furydex-universal-swap";
    ...
    switch (networkEventType) {
      case NetworkEventType.EVM:
        ...
        if (topics.includes(keccak256HashString(sendToCosmosEvent))) {
          ...
          const routeData: FuryBridgeRouteData = unmarshalFuryBridgeRoute(eventData[2]);
          const sendToCosmosData = {
            ...
            furyBridgeChannelId: routeData.furyBridgeChannel,
            furyReceiver: routeData.furyReceiver,
        ...
        break;
      case NetworkEventType.FURYBRIDGE:
        break;
      case NetworkEventType.FURYA:
        break;
      default:
        break;
    }
...
export class FuryBridgeEvent extends CosmosEvent {}

export class FuryaEvent extends CosmosEvent {}
